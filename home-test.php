...
<article <?php post_class('clearfix'); ?> role="article">
                ...
                <p class="info-box"><em><strong>Sensitive Skin #9</strong></em> features an exclusive interview with, and music by, seminal prog-rock guitarist Fred Frith (Henry Cow), the missing chapter from the latest novel by science
